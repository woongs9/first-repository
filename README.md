...
임근웅
### 뉴스 요약 
저커버거는 영화"아이언맨"의 인공지능 비서 '자비스'와 같은 인공지능 '자비스'를 개발 했다. 아직 부족한 점이 많고 갈길이 멀지만 끝임없이 도전 하겠다.
### 느낀점 
많은 개발자들의 노력으로 이제 더 이상 완벽한 인공지능 비서가 영화에서만 보던 허황된 꿈이 아니라 현실에서 만나게 될 날이 멀지 않았다. 나 또한 한명의 어엿한 인공지능 개발자로 성장해 인류의 편안한 삶에 기여`해야겠다.
